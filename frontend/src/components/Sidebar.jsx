...
function UserFooter() {
  ...
  return (
    <div className="mt-auto pt-6 border-t border-dark-700/50">
      ...
      <button
        onClick={logout}
        className="w-full flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-medium text-dark-300 hover:text-red-400 hover:bg-red-500/10 border border-transparent hover:border-red-500/20 transition-all cursor-pointer"
      >
